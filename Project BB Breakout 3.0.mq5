...
#property description "Project BB Breakout | LQS + Breakout Continuation | XAUUSD M1 v3.0"
...
int OnInit()
{
   ...
   Print("Project BB Breakout v3.0 | Symbol=", Symbol(),
         " | Magic=", MagicNumber,
         " | Exit=", exitMode,
